---
title: "Motors Overview: NEO, Kraken, and CIM in FRC"
sidebarTitle: "Motors Overview"
description: "Compare the three motor types supported in FRC Academy — REV NEO, CTRE Kraken, and CIM via PWMSparkMax — and learn which Java classes and imports each requires."
---
