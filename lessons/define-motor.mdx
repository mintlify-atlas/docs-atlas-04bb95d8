...
<Note>
  In a real WPILib robot project, this field declaration lives in `RobotContainer.java` (Command-Based) or `Robot.java` (TimedRobot). The `private final` modifiers ensure the motor object is created once and shared across your robot code.
</Note>
